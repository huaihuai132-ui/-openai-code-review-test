<template>
    <div class="static-file-upload">
        ...
        <div v-if="uploadProgress.show" class="upload-progress">
            ...
            <!-- 取消上传按钮 -->
            <div v-if="uploadProgress.status === 'info'" class="cancel-upload">
                <el-button size="small" @click="cancelUpload">取消上传</el-button>
            </div>
        </div>

        <!-- 上传成功后的操作按钮 -->
        <div v-if="!uploading && showUploadButton && fileList.length > 0" class="upload-actions">
...
import { useStaticFileUpload } from './hooks/useStaticFileUpload'
...
const { uploadUrl, httpRequest: originalHttpRequest } = useStaticFileUpload(props.directory)
